...
cd ~/src/the-repo
npx @dvm/copilot-room --host 0.0.0.0 --org my-org/my-team --hosts alice
```

Exporting a secret by hand writes it into your shell history. Every entry
point - `npx @dvm/copilot-room`, `npm run dev`, and the Docker image - reads a
